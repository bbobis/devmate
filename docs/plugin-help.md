...
This file is the canonical capability map for agents. All capability tables below are generated from `docs/capability-registry.json`. Do not edit the generated sections — run `node scripts/generate-docs.mjs` to regenerate.
