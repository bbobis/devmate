 ...
 * @property {boolean} alignmentBeforeImpl  A codebase-search precedes the first source edit (#238).
 * @property {number}  score                Count of the above that hold.
 */
...
/** @typedef {import('./workflow/alignment.mjs').AlignmentDecision} AlignmentDecision */
 ...
 * @property {AlignmentDecision[]} [alignment] Optional/advisory codebase-alignment decisions for the fix (issue 240); same reuse|extend|add shape the feature-lane planner task carries. When present, each entry must be well-formed.
 * @property {string}   taskId
 * @property {number}   schemaVersion        Must equal 1 for this version.
 */
