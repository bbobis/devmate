 ...
 *
 * The chains end where a human must speak:
 *  - feature → `spec-draft`     (human: `approve spec`)
 *  - bug     → `plan-approved`  (human: `approve plan`)
 *  - chore   → `impl-started`   (no human gate — the lane is mechanical)
 *
...
export const LANE_CHAINS = Object.freeze({
  ...
  bug: Object.freeze(
    /** @type {readonly GateEvent[]} */ (['set-lane', 'finish-grill', 'present-plan']),
  ),
  chore: Object.freeze(
    /** @type {readonly GateEvent[]} */ (['set-lane', 'present-plan', 'start-impl']),
  ),
});
